...
const LOCAL_STORAGE_KEY = 'pagamentos_fabrica';
...
const PagamentosFabrica: React.FC = () => {
    ...
    const handleSave = () => {
        ...
        else setPagamentos(prev => [...prev, { ...p, id: `pay-fab-${Date.now()}` }]);
    ...
    return (
        <div className="p-4 sm:p-6 w-full h-full overflow-y-auto">
            ...
            {activeTab === 'transferencias' && <TransferenciasEmpresas storageKeySuffix="_fabrica" />}
            {activeTab === 'autorizacao' && <AutorizacaoPagamento storageKeySuffix="_fabrica" />}
