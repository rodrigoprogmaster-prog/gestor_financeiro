            ...
            <div className="bg-card rounded-lg shadow-xl p-8 w-full max-w-sm">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex justify-end gap-4">
                        {!isInitialUnlock && (
                            <button type="button" onClick={onClose} className="py-2 px-4 rounded-lg bg-secondary hover:bg-border font-semibold transition-colors">
                                Cancelar
                            </button>
                        )}
                        <button type="submit" className="py-2 px-4 rounded-lg bg-primary hover:bg-primary-hover text-white font-semibold transition-colors">
                            Confirmar
                        </button>
                    </div>
                </form>
