        ...
        return (
            <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-start justify-center z-50 p-4 animate-fade-in overflow-y-auto">
                <div className="bg-white text-black w-full max-w-5xl rounded-sm shadow-2xl overflow-hidden flex flex-col font-sans my-4 relative">
                    ...
                    {/* Floating Toolbar */}
                    <div className="sticky top-0 bg-slate-800 text-white p-4 flex justify-between items-center z-10 shadow-md print:hidden">
                        <h3 className="font-bold text-lg">Visualização da Nota Fiscal (Simulação DANFE)</h3>
                        <div className="flex items-center gap-4">
                            <button onClick={() => window.print()} className="flex items-center gap-2 hover:text-blue-300 transition-colors">
